            ...
            <div class="events_info">
                <div class="events_videos">
                    <div class="videos_normal">
                        ...
                        <div class="videos_switch_right normal" onclick="changeCaster(this)">
                            <div class="videos_switch_setting normal">Auto Cam</div>
                            <div class="videos_switch_box">
                                <div class="videos_switch_button"></div>
                            </div>
                            <div class="videos_switch_setting compact">Manual</div>
                        </div>
                        @if($show_jumbo)
...
<script>
    var event_stream_id = '{{$event_object->id}}';
...
<script src="/js/v1/events.js?v=201706144"></script>
@endpush