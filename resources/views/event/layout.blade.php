...
<head>
    ...
    <link rel="stylesheet" media="all" type="text/css" href="{{elixir('css/rel/main-app.css') }}" >
    ...
    <link rel="stylesheet" media="all" type="text/css" href="{{elixir('css/slick/main.css') }}" >
    ...
    <script type="text/javascript" src="{{ elixir('js/rel/main-header.js')}}"></script>
</head>
<body>
...
<script type="text/javascript">
    ...
    var DEFAULT_NUMBER_SLICK = 6;
    var urlImageFilter = "{{route('filterImage')}}";
</script>
<script type="text/javascript" src="{{elixir('js/rel/main-footer.js')}}"></script>
