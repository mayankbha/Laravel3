...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="{{route('postUploadClient2')}}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="upload_original_name" id="upload_original_name"/> <br />
                <label for="update">Updates:</label><br />
                <input type="file" name="update" multiple> <br />
            ...
            $(document).ready(function () {
                ...
                form.fileupload({
                    ...
                    add: function (event, data) {
                        ...
                        var folders = ["{{$folderSetup}}", "{{$folderServer}}", version];
